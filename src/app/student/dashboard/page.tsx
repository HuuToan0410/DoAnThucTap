...
import { BookOpen, Calendar, Clock, Award, TrendingUp, Bell, CheckCircle, AlertCircle } from "lucide-react";
...
export default function StudentDashboard() {
  ...
  const upcomingClasses = [
    { subject: "Lập trình Web", time: "07:30 - 09:00", room: "A203", teacher: "Nguyễn Văn A", day: "Thứ Hai" },
    { subject: "Cơ sở dữ liệu", time: "09:15 - 10:45", room: "B105", teacher: "Trần Thị B", day: "Thứ Ba" },
    { subject: "Mạng máy tính", time: "13:00 - 14:30", room: "C301", teacher: "Lê Văn C", day: "Thứ Tư" },
  ];

  const upcomingExams = [
    { subject: "Cơ sở dữ liệu", date: "20/11/2025", time: "07:30", room: "A203", type: "Giữa kỳ" },
    { subject: "Lập trình Java", date: "22/11/2025", time: "09:00", room: "B105", type: "Cuối kỳ" },
  ];

  const announcements = [
    { title: "Thông báo đăng ký học phần học kỳ 2", time: "2 giờ trước", priority: "high" },
    { title: "Lịch thi giữa kỳ đã được cập nhật", time: "5 giờ trước", priority: "medium" },
    { title: "Hướng dẫn sử dụng hệ thống mới", time: "1 ngày trước", priority: "low" },
  ];

  const achievements = [
    { label: "Điểm trung bình", value: "8.5", icon: Award, color: "#f59e0b" },
    { label: "Số tín chỉ đã học", value: "48", icon: BookOpen, color: "#8b5cf6" },
    { label: "Số môn đã qua", value: "12", icon: CheckCircle, color: "#10b981" },
  ];
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl shadow-lg p-6 text-white">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              ...
              <p className="text-blue-100">Hãy cùng xem tình hình học tập của bạn hôm nay</p>
            </div>
            <div className="text-right">
              <p className="text-blue-100 text-sm">Hôm nay</p>
              <p className="text-xl font-semibold">{new Date().toLocaleDateString('vi-VN', { weekday: 'long', day: 'numeric', month: 'long' })}</p>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 bg-white rounded-xl shadow-md p-6">
            ...
            <div className="space-y-3">
              {upcomingClasses.map((cls, idx) => (
                <div key={idx} className="border border-gray-200 rounded-lg p-4 hover:border-blue-300 hover:shadow-sm transition">
            ...
            <div className="space-y-3">
              {announcements.map((ann, idx) => (
                <div key={idx} className="border-l-4 pl-3 py-2" style={{
                  borderLeftColor: ann.priority === "high" ? "#ef4444" : ann.priority === "medium" ? "#f59e0b" : "#6b7280"
                }}>
                  <p className="text-sm font-medium text-gray-800 mb-1">{ann.title}</p>
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {upcomingExams.map((exam, idx) => (
              <div key={idx} className="border-2 border-red-200 bg-red-50 rounded-lg p-4 hover:border-red-300 transition">
        ...
        <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl shadow-md p-6 border border-purple-200">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <button className="bg-white p-4 rounded-lg hover:shadow-md transition text-center">
              ...
              <p className="text-sm font-medium text-gray-700">Thời khóa biểu</p>
            </button>
            <button className="bg-white p-4 rounded-lg hover:shadow-md transition text-center">
            ...
            <button className="bg-white p-4 rounded-lg hover:shadow-md transition text-center">
              ...
              <p className="text-sm font-medium text-gray-700">Kết quả học tập</p>
            </button>
            <button className="bg-white p-4 rounded-lg hover:shadow-md transition text-center">
              <CheckCircle className="h-6 w-6 text-purple-600 mx-auto mb-2" />
              <p className="text-sm font-medium text-gray-700">Đăng ký HP</p>
            </button>
          </div>
        </div>
